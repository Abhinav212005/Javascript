...
console.log(newString); // hite and last value is not included

const anotherString = gameName.slice(-8, 4) // negative value can be given
console.log(anotherString);

const newStringOne = "   hitesh    "
console.log(newStringOne);//    hitesh    ;exactly the same is printed
console.log(newStringOne.trim());// hitesh ;it trims the spaces
